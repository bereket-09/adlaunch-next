...
export default function AdminLoginPage() {
    ...
    return (
        <div className="min-h-screen bg-white flex font-sans overflow-hidden relative">
            ...
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-orange-600/3 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/2" />

            <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative z-10">
                <div className="w-full max-w-[420px] space-y-10">
                    <div className="text-center space-y-4">
                        <div className="inline-flex items-center justify-center p-4 bg-slate-50 backdrop-blur-md rounded-3xl border border-slate-100 shadow-xl animate-fade-in">
