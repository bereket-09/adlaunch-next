                ...
                <div className="w-full max-w-[400px] space-y-12">
                    <div className="text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-500 font-medium text-lg">Connect with your audience through premium video</p>
                        </div>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="space-y-2">
                            <Label htmlFor="email" className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em] pl-1">Business Email</Label>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center px-1">
                                <Label htmlFor="password" title="Your Account Password" className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em]">Password</Label>
                        ...
                        <Button
                            type="submit"
                            variant="gradient"
                            className="w-full h-14 rounded-[1.25rem] text-lg font-black tracking-widest uppercase italic shadow-orange-glow active:scale-[0.98] transition-all hover:opacity-95"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                    ...
                    <div className="space-y-8 pt-4">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300">Switch Portals</span>
                            <div className="h-px flex-1 bg-slate-100" />
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            >
                                Go to Admin Portal <Sparkles className="h-3 w-3 text-slate-200 group-hover:text-primary transition-colors" />
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-10 max-w-lg space-y-12">
                    <div className="space-y-8">
                        ...
                        <h2 className="text-7xl font-black text-white leading-[0.95] tracking-tighter italic uppercase">
                            Elevate <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-primary">Your Brand.</span>
                        </h2>
                        <p className="text-xl text-slate-400 leading-relaxed font-medium max-w-md">
                            Join elite partners leveraging our premium platform to engage audiences and drive meaningful results.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-12 border-t border-white/5 pt-12">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] leading-tight">Global <br />Network Reach</p>
                        </div>
                    </div>
                </div>
            </div>
