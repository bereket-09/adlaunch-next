                ...
                <div className="w-full max-w-[400px] space-y-12">
                    <div className="text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-4xl font-black tracking-tight text-slate-900 italic uppercase">Partner Hub</h1>
                            <p className="text-slate-500 font-medium text-lg">Impact more through premium video</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <Input
                                    id="email"
                                    type="email"
                                    placeholder="partner@brand.et"
                                    value={email}
                                    onChange={(e) => setEmail(e.target.value)}
                                    className="pl-12 h-14 rounded-[1.25rem] border-slate-100 bg-slate-50/50 focus:ring-4 focus:ring-primary/10 transition-all font-medium placeholder:text-slate-300 shadow-sm"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center px-1">
                                <Label htmlFor="password" title="Your Account Password" className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Security Key</Label>
                                <a href="#" className="text-[10px] font-black text-primary hover:text-orange-600 transition-colors uppercase tracking-widest">Forgot?</a>
                            </div>
                            <div className="relative group">
                                ...
                                <Input
                                    ...
                                    className="pl-12 pr-12 h-14 rounded-[1.25rem] border-slate-100 bg-slate-50/50 focus:ring-4 focus:ring-primary/10 transition-all font-medium placeholder:text-slate-300 shadow-sm"
                                    required
                                />
                                <button
                                    type="button"
                        ...
                        <Button
                            type="submit"
                            variant="gradient"
                            className="w-full h-14 rounded-[1.25rem] text-lg font-black tracking-widest uppercase italic shadow-2xl active:scale-[0.98] transition-all hover:opacity-95"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                    ...
                    <div className="space-y-8 pt-4">
                        <p className="text-center text-xs font-semibold text-slate-400 tracking-wide uppercase">
                            New partner? <Link href="/marketer/register" className="text-primary font-black hover:underline decoration-2 underline-offset-4 tracking-[0.05em]">Enroll Now</Link>
                        </p>

                        <div className="flex items-center gap-6">
                            <div className="h-px flex-1 bg-slate-100" />
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300">Management Portals</span>
                            <div className="h-px flex-1 bg-slate-100" />
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            >
                                Admin Terminal <Sparkles className="h-3 w-3 text-slate-200 group-hover:text-primary transition-colors" />
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="hidden lg:flex flex-1 bg-slate-50 relative overflow-hidden items-center justify-center p-24">
                ...
                <div className="relative z-10 max-w-lg space-y-12">
                    <div className="space-y-8">
                        <div className="h-16 w-16 bg-white rounded-[2rem] flex items-center justify-center border border-slate-100 shadow-2xl shadow-slate-200/50 animate-fade-in">
                            <Sparkles className="h-8 w-8 text-orange-500" />
                        </div>
                        <h2 className="text-7xl font-black text-slate-900 leading-[0.95] tracking-tighter italic uppercase">
                            Reach <br />
                    ...
                    <div className="grid grid-cols-2 gap-12 border-t border-slate-100 pt-12">
                        <div className="space-y-2">
                            <p className="text-4xl font-black text-slate-900 tracking-tighter italic">98.4%</p>
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] leading-tight">Verified <br />Completion</p>
                        </div>
                        <div className="space-y-2">
                            <p className="text-4xl font-black text-slate-900 tracking-tighter italic">100k+</p>
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] leading-tight">Regional <br />Network Reach</p>
                        </div>
                    </div>
                </div>
            </div>
